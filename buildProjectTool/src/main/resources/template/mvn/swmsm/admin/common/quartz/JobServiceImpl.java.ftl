...
import ${basePackageName}.${projectName}.core.dao.common.TaskDao;
import ${basePackageName}.${projectName}.core.entity.TaskDO;
import ${basePackageName}.${projectName}.core.entity.ScheduleJob;
import ${basePackageName}.${projectName}.core.util.ScheduleJobUtils;
...
<TaskDO> list(Map
    ...
    // 这里获取任务信息数据
    List
    <TaskDO> jobList = taskDao.list(new HashMap
        <String
        , Object>(16));
